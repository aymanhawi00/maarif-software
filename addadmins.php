<?php
    ...
    if (isset($_POST['register'])) {
        ...
        if ($username != $row['username'] && $adminemail != $row['admin_email'] || $adminemail != $row['admin_email'] || $username != $row['username']) {

            $sql = "INSERT INTO admins (admin_email, username, admin_name, pass) VALUES ('$adminemail', '$username', '$name', '$password')";
            mysqli_query($conn, $sql);

        } else
        if ($username == $row['username'] && $adminemail == $row['admin_email']) {

            echo "<script>window.top.location='settings.php?bothexists'</script>";

        } else if ($adminemail == $row['admin_email']) {
            echo "<script>window.top.location='settings.php?adminemailexists'</script>";
        } else if ($username == $row['username']) {
            echo "<script>window.top.location='settings.php?adminusernametaken'</script>";
        }
    }
?>
<?php
...
<head>
    ...
    <title>Add Admin - Settings</title>
        ...
        <div class="row no-gutters row-bordered row-border-light">
            ...
            <div class="col-md-9" style="min-height: 700px;">
                <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="add-admins">
                            <div class="card-body pb-2">
