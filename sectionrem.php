      ...
      <div class="wrapper">
         ...
         <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post" enctype="multipart/form-data">
               ...
               include("database.php");
                     ...
                     {
                     echo "<div class='alert alert-success text-center mt-3 mb-0'>Section successfully removed!</div>";
                     }
               ?>
...
<?php
   if(isset($_POST['deletesection'])) {
      ...
      echo "<script>window.top.location='sectionrem.php?success'</script>";
   }
?>