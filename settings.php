...
<?php
if (isset($_GET['actionnotallowed'])) {
    echo "

    <div style='position: fixed; top: 50%; height: 100vh; width: 100%; margin: 0; padding: 0; box-sizing: border-box; left: 50%; transform: translateX(-50%) translateY(-50%); z-index: 999; width: 25%; height: 35%; transition: all 500ms 2s ease; background-color: #fff; outline: none; box-shadow: 0 0 25px 5px rgba(170,170,170.1); border-radius: 9px;' id='box'>
        <div style='height: 100%; width: 100%;'>
                <div style='height: 65%; width: 100%; display: flex; justify-content: center; align-items: center;'>
                    <img src=images/danger-icon.PNG alt=Danger Icon style='height: 60%;'>
                </div>

                <div style='height: 10%; width: 100%; display: flex; justify-content: center; align-items: center;'>
                    <div style='display: flex; justify-content: center; align-items: center; text-align:center; font-size: 19px; color: black; height: 100%; width: 100%; padding: 0 70px;'>
                        <strong>Your role doesn't allow you to perform this action!</strong>
                    </div>
                </div>

                <div style='height: 25%; width: 100%; display: flex; justify-content: center; align-items: center;'>
                    <button class='px-3 py-2 border-0 fs-6 text-white rounded-top rounded-bottom' id='close' style='background-color: #5ab5c7; outline: none;'>Okay</button>
                </div>
        </div>
    </div>
    <script>
            ...
            <div class="row no-gutters row-bordered row-border-light">
                <div class="col-md-3 pt-0">
                    <div class="list-group list-group-flush account-settings-links">
                        ...
                        <a class="list-group-item list-group-item-action"
                        href="trackattendance.php">Track Attendance</a>
                        <a class="list-group-item list-group-item-action"
